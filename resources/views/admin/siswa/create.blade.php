                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.siswa.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="nama_depan" class="form-control" type="text" id="nama_depan" value="{{ old('nama_depan') }}">
                                    @error('nama_depan')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="nama_belakang" class="form-control" type="text" id="nama_belakang" value="{{ old('nama_belakang') }}">
                                    @error('nama_belakang')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="no_induk_siswa" class="form-control" type="number" id="no_hp" value="{{ old('no_induk_siswa') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="no_hp" class="form-control" type="text" id="no_hp" value="{{ old('no_hp') }}">
                                    @error('no_hp')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="alamat" class="form-control" type="text" id="alamat" value="{{ old('alamat') }}">
                                    @error('alamat')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <select name="ekstrakulikuler_id" class="form-select" id="ekstrakulikuler_id">
                                        @foreach($ekstrakulikulers as $ekstrakulikuler)
                                            <option value="{{ $ekstrakulikuler->id }}" {{ old('ekstrakulikuler_id') == $ekstrakulikuler->id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg mt-3" src="{{ url('upload/admin_images/no_image.jpg') }}" alt="Card image cap">
                                </div>
                            </div>

                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Add Siswa">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->
